...
const { dialogConst } = require("../constants/dialogID");
...
class MainDialog extends ComponentDialog {
  constructor(conversationState, userState) {
    ...
    this.initialDialogId = dialogConst.ROOT_DIALOG_WATERFALL_1;
  }
      ...
      switch (text) {
        ...
        case "logout":
          ...
          await userTokenClient.signOutUser(
            activity.from.id,
            process.env.AuthConnectionName,
            activity.channelId
          );
